			...
			<table style="width:100%" width="100%">
				<tr>
					<td>
						...
						<h3 style='color:#000; font-family:"Helvetica Neue", Helvetica, Arial, "Lucida Grande", sans-serif; font-size:22px; font-weight:200; line-height:1.2; margin:40px 0 10px'>这是来自云印南天yunyin.org密码找回邮件</h3>
						...
						<h3 style='color:#000; font-family:"Helvetica Neue", Helvetica, Arial, "Lucida Grande", sans-serif; font-size:22px; font-weight:200; line-height:1.2; margin:40px 0 10px'>输入以下验证码完成验证然后重置密码</h3>
						<table style="width:100%" width="100%">
							<tr>
								<td style="padding:10px 0">
									<p style="font-size:14px; font-weight:normal; margin-bottom:10px"><code style="background-color:#348eda; border:solid #348eda; border-radius:15px; border-width:10px 20px; color:#FFF; cursor:pointer; display:inline-block; font-weight:bold; line-height:2; margin-right:10px; text-align:center; text-decoration:none" bgcolor="#348eda" align="center"><?=$code?></code></p>
								</td>
							</tr>
						</table>
						<br>
